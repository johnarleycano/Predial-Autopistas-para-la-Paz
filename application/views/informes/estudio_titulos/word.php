...
$properties->setLastModifiedBy('CF');
...
$table->addCell(10000, $styleCell)->addImage('./img/logo.png',
array(
  'width' => 68,
  'height' => 80,
  'align' => 'left',
...
$table->addCell(10000, $styleCell)->addText("DEVIMED S.A", 'parrafo2', $alineacion_centrada);
...
$seccion1->addText("BYRON ARBOLEDA", 'titulo2', $alineacion_centrada);
$seccion1->addText("C.C Nº XXX.XXX.XXX", 'parrafo2', $alineacion_centrada);
$seccion1->addText("T.P Nº XXX.XXX del C.S de la Judicatura", 'parrafo2', $alineacion_centrada);


$footer = $seccion1->createFooter();
$footer->addText("DEVIMED S.A | CRA. 43A 7-50  Medellin, Antioquia", 'titulo3', $alineacion_centrada);
$footer->addText("PBX (574) 444 4238", 'titulo3', $alineacion_centrada);
$footer->addPreserveText('www.devimed.com.co | Página {PAGE} de {NUMPAGES}', 'titulo3', $alineacion_centrada);
