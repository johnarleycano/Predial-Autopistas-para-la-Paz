			...
			<div id="encabezado">
				<div id="usuario">
					<table>
						<tbody>
							<tr>
								<td rowspan="3"><?php if($this->session->userdata('nombre_usuario') == TRUE)  echo "<a href=".site_url('usuario_controller')."><img title='Datos de Usuario' src='".base_url().'img/user2.png'."'></a>"; ?></td>
