<div>
    <?= form_fieldset('<b>Identificación de impactos y diágnostico socioeconómicos</b>') ?>
        ...
        <?php $data = array('name'=>'diagnostico', 'value'=>$diagnostico->observaciones, 'rows'=>'10') ?>
        <?= form_textarea($data) ?>
</div>

<div>
    <?= form_label('Factor de apoyo al restablecimiento de vivienda', 'apoyo_restablecimiento') ?>
    <?php $data = array('name'=>'apoyo_restablecimiento', 'value'=>$diagnostico->apoyo_restablecimiento, 'style'=>'width:70%') ?>
    <?= form_input($data) ?>
    <?php $data = array('name'=>'apoyo_restablecimiento_valor', 'value' => $diagnostico->apoyo_restablecimiento_valor, 'placeholder' => 'Subtotal', 'style'=>'float:right') ?>
    <?= form_input($data) ?>
</div>
...
<div>
    ...
    <br>
    <?php $data = array('name'=>'apoyo_moradores', 'value'=>$diagnostico->apoyo_moradores, 'style'=>'width:70%') ?>
    <?= form_input($data) ?>
    <?php $data = array('name'=>'apoyo_moradores_valor', 'value'=>$diagnostico->apoyo_moradores_valor, 'placeholder'=>'Subtotal', 'style'=>'float:right') ?>
    <?= form_input($data) ?>
</div>
...
<div>
    ...
    <br>
    <?php $data = array('name'=>'apoyo_tramites', 'value'=>$diagnostico->apoyo_tramites, 'style'=>'width:70%') ?>
    <?= form_input($data) ?>
    <?php $data = array('name'=>'apoyo_tramites_valor', 'value'=>$diagnostico->apoyo_tramites_valor, 'placeholder'=>'Subtotal', 'style'=>'float:right') ?>
    <?= form_input($data) ?>
</div>
...
<div>
    ...
    <br>
    <?php $data = array('name'=>'apoyo_movilizacion', 'value'=>$diagnostico->apoyo_movilizacion, 'style'=>'width:70%') ?>
    <?= form_input($data) ?>
    <?php $data = array('name'=>'apoyo_movilizacion_valor', 'value'=>$diagnostico->apoyo_movilizacion_valor, 'placeholder'=>'Subtotal', 'style'=>'float:right') ?>
    <?= form_input($data) ?>
</div>
...
<div>
    ...
    <br>
    <?php $data = array('name'=>'restablecimiento_servicios', 'value'=> $diagnostico->restablecimiento_servicios, 'style'=>'width:70%') ?>
    <?= form_input($data) ?>
    <?php $data = array('name'=>'restablecimiento_servicios_valor', 'value'=>$diagnostico->restablecimiento_servicios_valor, 'placeholder'=>'Subtotal', 'style'=>'float:right') ?>
    <?= form_input($data) ?>
</div>
...
<div>
    ...
    <br>
    <?php $data = array('name'=>'restablecimiento_economico', 'value'=> $diagnostico->restablecimiento_economico, 'style'=>'width:70%') ?>
    <?= form_input($data) ?>
    <?php $data = array('name'=>'restablecimiento_economico_valor', 'value'=>$diagnostico->restablecimiento_economico_valor, 'placeholder'=>'Subtotal', 'style'=>'float:right') ?>
    <?= form_input($data) ?>
</div>
...
<div>
    ...
    <br>
    <?php $data = array('name'=>'apoyo_arrendadores', 'value'=> $diagnostico->apoyo_arrendadores, 'style'=>'width:70%') ?>
    <?= form_input($data) ?>
    <?php $data = array('name'=>'apoyo_arrendadores_valor', 'value'=> $diagnostico->apoyo_arrendadores_valor, 'placeholder'=>'Subtotal', 'style'=>'float:right') ?>
    <?= form_input($data) ?>
</div>
